...
DEST_PROJECT_MANAGER_COL = 5665034080046980 # Project manager column on 04 sheet
...
DRY_RUN = os.getenv("DRY_RUN_BACK_END", "false").lower() == "true"
...
def list_all_source_project_rows() -> List[Dict[str, Any]]:
    ...
    logging.info(f"[SmartsheetSync] Fetching all source rows from sheet {SOURCE_SHEET_ID} with Row='{ROW_VALUE_PROJECT}' and Order='{ORDER_VALUE_PROJECT}' and  Back-End - Site Work not blank")
    ...
    for srow in source_rows:
        ...
        if dest_row is None:
            ...
            if src_back_end_val == "Phoenix" or src_back_end_val == "Subcontractor":
                ...
                mapped_cells.append({"columnId": 1618831289831300, "value": ROW_VALUE_BACK_END}) # Primary column
                ...
                logging.info(f"[Plan] SKIP insert tank={tank_key} (Back-End - Site Work = {src_back_end_val})")
        else:
